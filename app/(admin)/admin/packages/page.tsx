...
import { Trash2, Edit2, Plus, Package, MapPin, Star, Loader, Search, X } from 'lucide-react';
...
export default function PackagesAdminPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.id || !formData.title || !formData.location || !formData.price) {
  ...
  const removeItineraryDay = (index: number) => {
    ...
    setFormData({ ...formData, itinerary: updated.length > 0 ? updated : [{ day: 1, title: '', description: '' }] });
  };
    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your travel packages</p>
        </div>
        <Button
          onClick={() => {
            resetForm();
      ...
      {loading ? (
        ...
        <div className="grid gap-4">
          {filteredPackages.map((pkg) => (
            <Card key={pkg._id} className="border-0 shadow-soft hover:shadow-md transition-shadow">
              <CardContent className="p-5">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground text-lg">{pkg.title}</h3>
      ...
      <Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
        <SheetContent className="w-full sm:max-w-xl">
          <SheetHeader>
            <SheetTitle>{editingId ? 'Edit Package' : 'Add New Package'}</SheetTitle>
            <SheetDescription>
              {editingId ? 'Update package details' : 'Create a new travel package'}
            </SheetDescription>
          </SheetHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 py-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <h4 className="font-medium text-sm text-muted-foreground">Highlights</h4>
                  <Button type="button" variant="ghost" size="sm" onClick={() => addArrayItem('highlights')}>
                    <Plus className="w-4 h-4" />
                  </Button>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" variant="ghost" size="sm" onClick={() => addArrayItem('included')}>
                    <Plus className="w-4 h-4" />
                  </Button>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <h4 className="font-medium text-sm text-muted-foreground">Not Included</h4>
                  <Button type="button" variant="ghost" size="sm" onClick={() => addArrayItem('notIncluded')}>
                    <Plus className="w-4 h-4" />
                  </Button>
                </div>
