...
import { Trash2, Edit2, Plus, FileText, User, Clock, Loader, Search, X } from 'lucide-react';
      ...
      {loading ? (
        ...
        <div className="grid gap-4">
          {filteredPosts.map((post) => (
            <Card key={post._id} className="border-0 shadow-soft hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-foreground text-lg truncate">{post.title}</h3>
      ...
      <Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
        <SheetContent className="w-full sm:max-w-xl">
          <SheetHeader>
            ...
            <SheetDescription>
              {editingId ? 'Update blog post details' : 'Create a new blog post'}
            </SheetDescription>
          </SheetHeader>
          ...
          <ScrollArea className="flex-1 px-1 -mx-1">
            <form onSubmit={handleSubmit} className="space-y-6 py-4">
              ...
              {/* Author Info */}
              <div className="space-y-4">
                <h4 className="font-medium text-sm text-muted-foreground">Author Information</h4>
                <div className="grid grid-cols-2 gap-3">
                  <Input
