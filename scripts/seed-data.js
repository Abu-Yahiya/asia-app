...
const blogPosts = [
  {
    ...
    excerpt: 'Discover off-the-beaten-path destinations that will make your Greek adventure unforgettable.',
...
This remote island in the northern Aegean is a paradise for nature lovers.`,
  ...
  },
  {
    ...
    excerpt: 'Everything you need to know about experiencing sakura season like a local.',
...
- Maruyama Park: Kyoto's most popular hanami spot`,
  ...
  },
  {
    ...
    excerpt: 'Essential tips and packing list for conquering the Inca Trail adventure.',
...
- Rain jacket and poncho`,
  ...
  },
  {
    ...
    excerpt: "Experience the height of opulence with our insider guide to Dubai's finest offerings.",
...
const visaCountries = [
  {
    ...
    description: 'The United States offers various visa categories for tourists, business travelers, students, and workers.',
    requirements: [
  ...
  },
  {
    ...
    processing: '5-7 days',
    type: 'Visitor Visa',
    description: 'The UK Standard Visitor visa lets you visit for tourism, business meetings, or short courses.',
    requirements: [
      'Valid passport',
  ...
  },
  {
    ...
    type: 'Tourist/Work',
    description: 'Canada offers eTA for visa-exempt nationals and visitor visas for others.',
    requirements: [
      'Valid passport',
      'Digital photograph',
      'Proof of funds',
  ...
  },
  {
    ...
    processing: '5-7 days',
    type: 'eVisitor',
    description: "Australia's eVisitor (subclass 651) and ETA make it easy for eligible nationals.",
    requirements: [
      'Valid passport',
      'Health declaration',
  ...
  },
  {
    ...
    type: 'Short Stay',
    description: 'The Schengen visa grants access to 27 European countries with a single visa.',
    requirements: [
  ...
  },
  {
    ...
    processing: '5-7 days',
    type: 'Tourist Visa',
    description: 'Japan\'s tourist visa process is straightforward for most nationalities.',
    requirements: [
      'Valid passport',
...
const travelPackages = [
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 189,
    description: "Immerse yourself in Japanese culture during the magical sakura season. From Tokyo's bustling streets to Kyoto's serene temples.",
    highlights: [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 312,
    description: 'Trek through the Andes to the legendary Machu Picchu. This adventure combines ancient Incan heritage with stunning natural landscapes.',
    highlights: [
      'Inca Trail trek',
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 156,
    description: "Indulge in the ultimate luxury experience in Dubai. From the world's tallest building to desert safaris, experience opulence and adventure.",
    highlights: [
      'Burj Khalifa At The Top',
...
const services = [
  {
    ...
    duration: '30 min',
    longDescription: 'Get personalized travel advice from our experienced consultants who have explored destinations worldwide.',
    features: [
  ...
  },
  {
    ...
    duration: '45 min',
    longDescription: "Streamline your company's travel with our comprehensive corporate travel management service.",
    features: [
  ...
  },
  {
    ...
    duration: '20 min',
    longDescription: 'Our flight specialists search across hundreds of airlines to find you the best deals.',
    features: [
      'Best fare guarantee',
  ...
  },
  {
    ...
    duration: '15 min',
    longDescription: 'Protect your investment and travel with peace of mind with our comprehensive insurance plans.',
    features: [
  ...
  },
  {
    ...
    duration: '30 min',
    longDescription: 'Navigate complex visa processes with expert guidance from our visa specialists.',
    features: [
  ...
  },
  {
    ...
    duration: '45 min',
    longDescription: 'Let our travel designers create a day-by-day itinerary tailored to your interests, pace, and budget.',
    features: [
...
async function seedDatabase() {
  ...
  if (!mongoUri) {
    ...
    console.log('Run with: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-data.js');
    process.exit(1);
  }
  ...
  try {
    ...
    const VisaCountry = mongoose.models.VisaCountry || mongoose.model('VisaCountry', VisaCountrySchema);
